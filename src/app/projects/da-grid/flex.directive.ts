...
export class DaFlexDirective implements OnInit, OnDestroy {
  ...
  @Input()
  daFlex!: number | string;
  @Input()
  daFlexMs!: number | string;
  @Input()
  daFlexMn!: number | string;
  @Input()
  daFlexMl!: number | string;
  @Input()
  daFlexXs!: number | string;
  @Input()
  daFlexSm!: number | string;
  @Input()
  daFlexMd!: number | string;
  @Input()
  daFlexLg!: number | string;
  @Input()
  daFlexXl!: number | string;
