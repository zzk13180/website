...
export class RowComponent implements OnInit, OnChanges {
  ...
  @Input()
  daAlignSelfMs!: DaAlignSelf;
  @Input()
  daAlignSelfMm!: DaAlignSelf;
  @Input()
  daAlignSelfMl!: DaAlignSelf;
  @Input()
  daAlignSelfXs!: DaAlignSelf;
  @Input()
  daAlignSelfSm!: DaAlignSelf;
  @Input()
  daAlignSelfMd!: DaAlignSelf;
  @Input()
  daAlignSelfLg!: DaAlignSelf;
  @Input()
  daAlignSelfXl!: DaAlignSelf;
